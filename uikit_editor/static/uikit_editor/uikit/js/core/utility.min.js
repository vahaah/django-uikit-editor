...
!function (t, i) {
    ...
    i.component("stackMargin", {
        defaults: {cls: "@-margin-small-top"}, boot: function () {
            ...
            var t = this;
            this.revert();
            var n = !1, s = this.columns.filter(":visible:first"), o = s.length ? s.position().top + s.outerHeight() - 1 : !1;
            if (o !== !1)return this.columns.each(function () {
                var s = i.$(this);
                s.is(":visible") && (n ? s.addClass(t.options.cls) : s.position().top >= o && (n = s.addClass(t.options.cls)))
            }), this
        }, revert: function () {
